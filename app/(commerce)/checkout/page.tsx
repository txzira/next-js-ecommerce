...
//   return (
//     <>
//       <div className="grid h-14 grid-cols-5 items-center py-2">
//         <div className="col-span-2">
//           <p>{cartItem.productName}</p>
//           {cartItem.variantName ? (
//             <p className="text-sm text-gray-500">
//               Option: {cartItem.variantName}
//             </p>
//           ) : (
//             ""
//           )}
...
//           </select>
//           <button
//             className="absolute top-6 text-xs text-blue-600 underline"
...
//         <h1 className="pb-2 text-2xl font-bold">Shipping</h1>
...
//               onChange={(event) =>
//                 setShipping({ ...shipping, streetAddress: event.target.value })
//               }
//             />
//           </div>
//           <div className="flex w-[39%] flex-col">
//             <label
//               className="text-base font-semibold md:text-lg"
...
//               placeholder="Apt. 2"
//               onChange={(event) =>
//                 setShipping({ ...shipping, streetAddress2: event.target.value })
//               }
//             />
//           </div>
//         </div>
...
//               placeholder="25919"
//               onChange={(event) =>
//                 setShipping({ ...shipping, zipCode: event.target.value })
//               }
//             />
//           </div>
//         </div>
...
//   };
//   return (
//     <div className="my-10 rounded-xl bg-white p-2 shadow-lg">
//       <div>
//         <h1 className="pb-2 text-2xl font-bold">Payment</h1>
//         <p className="text-xs md:text-sm">
//           Note: Screenshot the transaction between your wallet address and one
//           of these addresses and attach it as your proof of payment image, leave
//           image blank if cash order.
//         </p>

//         <h1 className="pb-1 pt-3 text-xl font-semibold">Wallet Addresses</h1>
//         <div className="grid grid-cols-3 bg-black text-lg text-white">
...
//                     className="grid grid-cols-3 even:bg-slate-200">
//                     <div className="col-span-2 overflow-x-scroll pl-2">
...
//       </div>
//       {image ? (
//         <div className="relative mx-auto flex h-80 w-80 justify-center object-contain ">
...
//         <p className="text-sm">
//           If you wish to pay with cash, send it to the address below.
//         </p>
...
//         ORDERS WILL NOT SHIP UNTIL PAYMENT IS RECEIVED/VERIFIED.
//       </p>
//     </div>
//   );
// }
...
//           return (
//             <CartItem key={cartItem.id} cartItem={cartItem} mutate={mutate} />
//           );
//         })
//       ) : (
//         <div className="flex justify-center">
...
//         <Link
//           href="/user/products"
//           className="col-span-2  border-[1px] border-black p-2 text-[10px] font-medium">
//           CONTINUE SHOPPING
//         </Link>
//         <button
//           className="bg-green-600 p-2 text-[10px] font-medium text-white"
//           onClick={placeOrder}>
//           PLACE ORDER
//         </button>
//       </div>
